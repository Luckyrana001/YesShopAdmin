...
import AddAdjustments from "./scenes/creditDebit/AddAdjustments";
        ...
        <div className="app" onClick={handleProgressClick}>
          ...
          <main className="content">
            ...
            <Routes>
              ...
              <Route
                path={CONSTANT.FINANCE_DASHBOARD}
                element={<FinanceHomePage />}
              />
              {/* <Route path={CONSTANT.DELAER_DASHBOARD_ROUTE} element={<Dashboard />} /> */}

              <Route
                path={CONSTANT.VALIDATION_ROUTE}
                element={<Validations />}
              />

              <Route
                path={CONSTANT.PAYOUT_ARCHIEVE_ROUTE}
                element={<PayoutsArchive />}
              />

              <Route path={CONSTANT.PAYOUT_ROUTE} element={<Payouts />} />
              <Route
                path={CONSTANT.ON_HOLD_ROUTE}
                element={<OnHoldSummary />}
              />
              <Route path={CONSTANT.CONTACT_ROUTE} element={<Contacts />} />
              <Route path={CONSTANT.INVOICES_ROUTE} element={<Invoices />} />
              <Route
                path={CONSTANT.EXCLUSION_ROUTE}
                element={<ExclusionScreen />}
              />
              <Route
                path={CONSTANT.PAYOUT_DATES_ROUTE}
                element={<PayoutDatesScreen />}
              />
              <Route
                path={CONSTANT.WITHOLDING_TAX_ROUTE}
                element={<WitholdingTaxScreen />}
              />
              <Route
                path={CONSTANT.FREEZE_ACCOUNT_ROUTE}
                element={<FreezeAccountScreen />}
              />
              <Route
                path={CONSTANT.CREDIT_DEBIT_ROUTE}
                element={<CreditDebitScreen />}
              />
              <Route path={CONSTANT.REPORTS_ROUTE} element={<FAQ />} />
              <Route
                path={CONSTANT.EARMARK_ROUTE}
                element={<EarmarkScreen />}
              />
              <Route
                path={CONSTANT.REPORTS_FILTER_ROUTE}
                element={<FilterReports />}
              />
              <Route
                path={CONSTANT.PAYOUT_ALL_TRANSACTION_DETAILS}
                element={<PayoutsTransactionDetails />}
              />
              <Route
                path={CONSTANT.ON_HOLD_DETAILS_ROUTE}
                element={<OnHoldDetails />}
              />
              <Route
                path={CONSTANT.ON_HOLD_ALL_TRANSACTIONS_DETAILS}
                element={<OnHoldAllTransactionsDetails />}
              />
              <Route path={CONSTANT.SUCCESS_ROUTE} element={<SuccessPage />} />
              <Route
                path={CONSTANT.ADD_DEALER_ROUTE}
                element={<AddDealerScreen />}
              />
              <Route
                path={CONSTANT.UNFREEZE_FREEZE_DEALER_ROUTE}
                element={<FreezeUnfreezeDealer />}
              />
              <Route
                path={CONSTANT.ADD_ADJUSTMENTS_ROUTE}

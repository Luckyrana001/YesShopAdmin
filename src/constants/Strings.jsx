...
export const FETCHING_PAYOUT_DETAILS_PLEASE_WAIT =
  "Loading Payout Details , Please wait...";
export const FETCHING_PAYOUT_SUMMARY_PLEASE_WAIT =
  "Loading Payout Summary , Please wait...";

export const LOADING_PLEASE_WAIT = "Loading , Please wait...";
export const LOADING_CONFIGRATION_PLEASE_WAIT =
  "Loading Configration, Please wait...";
export const AUTHENTICATING_PLEASE_WAIT = "Authenticating, Please wait...";
export const ERROR_WHILE_AUTHENTICATING_USER =
  "Error while authenticating user: ";
export const ERROR_WHILE_RETRIEVING_BASIC_AUTH =
  "Error while retrieving basic auth: ";
export const ERROR_WHILE_FETCHING_PAYOUT_DETAILS =
  "Error while fetching Payout Details: ";
export const ERROR_FOUND_DURING_API_CALL = "An Error Occurred: ";
export const ERROR_WHILE_FETCHING_DATA = "Error while fetching Details: ";

            ...
            <Menu iconShape="square">
              ...
              <Box pt={2} paddingLeft={isCollapsed ? undefined : "10%"}>
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M15.1049 4.23075L4.70991 12.5558C3.53991 13.4858 2.78991 15.4508 3.04491 16.9208L5.03991 28.8608C5.39991 30.9908 7.43991 32.7157 9.59991 32.7157H26.3999C28.5449 32.7157 30.5999 30.9758 30.9599 28.8608L32.9549 16.9208C33.1949 15.4508 32.4449 13.4858 31.2899 12.5558L20.8949 4.24575C19.2899 2.95575 16.6949 2.95575 15.1049 4.23075Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                ...
                <Typography
                  ...
                  sx={{
                    m: "5px 0 5px 7px",
                    whiteSpace: isCollapsed ? "wrap" : "nowrap",
                  }}
                >
                  Incentive
                </Typography>
                ...
                <Item
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        <path
                          d="M32.9993 18.6953C32.9993 26.9753 26.2793 33.6953 17.9993 33.6953C9.71927 33.6953 2.99927 26.9753 2.99927 18.6953C2.99927 10.4153 9.71927 3.69531 17.9993 3.69531C26.2793 3.69531 32.9993 10.4153 32.9993 18.6953Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M23.5663 23.4659L18.9163 20.6909C18.1063 20.2109 17.4463 19.0559 17.4463 18.1109V11.9609"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                ...
                <Item
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        <path
                          d="M15.975 28.665V7.335C15.975 5.31 15.12 4.5 12.96 4.5H7.515C5.355 4.5 4.5 5.31 4.5 7.335V28.665C4.5 30.69 5.355 31.5 7.515 31.5H12.96C15.12 31.5 15.975 30.69 15.975 28.665Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M31.4987 28.665V7.335C31.4987 5.31 30.6437 4.5 28.4837 4.5H23.0387C20.8937 4.5 20.0237 5.31 20.0237 7.335V28.665C20.0237 30.69 20.8787 31.5 23.0387 31.5H28.4837C30.6437 31.5 31.4987 30.69 31.4987 28.665Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                ...
                <Item
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        <path
                          d="M18 33.3047C26.28 33.3047 33 26.5847 33 18.3047C33 10.0247 26.28 3.30469 18 3.30469C9.72 3.30469 3 10.0247 3 18.3047C3 26.5847 9.72 33.3047 18 33.3047Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                        ...
                        />
                        <path
                          d="M28.35 7.80469L7.34998 28.8047"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M31.5 13.3594V26.1094C31.5 30.6094 29.25 33.6094 24 33.6094H12C6.75 33.6094 4.5 30.6094 4.5 26.1094V13.3594C4.5 8.85938 6.75 5.85938 12 5.85938H24C29.25 5.85938 31.5 8.85938 31.5 13.3594Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                ...
                <Item
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        <path
                          d="M33 9V12.63C33 15 31.5 16.5 29.13 16.5H24V6.015C24 4.35 25.365 3 27.03 3C28.665 3.015 30.165 3.675 31.245 4.755C32.325 5.85 33 7.35 33 9Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                        ...
                        />
                        <path
                          d="M3 10.5V31.5C3 32.745 4.41 33.45 5.4 32.7L7.965 30.78C8.565 30.33 9.405 30.39 9.945 30.93L12.435 33.435C13.02 34.02 13.98 34.02 14.565 33.435L17.085 30.915C17.61 30.39 18.45 30.33 19.035 30.78L21.6 32.7C22.59 33.435 24 32.73 24 31.5V6C24 4.35 25.35 3 27 3H10.5H9C4.5 3 3 5.685 3 9V10.5Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                ...
                <Item
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        <path
                          d="M18 22.4453C20.0711 22.4453 21.75 20.7664 21.75 18.6953C21.75 16.6242 20.0711 14.9453 18 14.9453C15.9289 14.9453 14.25 16.6242 14.25 18.6953C14.25 20.7664 15.9289 22.4453 18 22.4453Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                        ...
                        />
                        <path
                          d="M7.5 33.6953C10.8137 33.6953 13.5 31.009 13.5 27.6953C13.5 24.3816 10.8137 21.6953 7.5 21.6953C4.18629 21.6953 1.5 24.3816 1.5 27.6953C1.5 31.009 4.18629 33.6953 7.5 33.6953Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                        ...
                        />
                        <path
                          d="M7.875 25.8203V27.2153C7.875 27.7403 7.60501 28.2353 7.14001 28.5053L6 29.1953"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                        ...
                        />
                        <path
                          d="M3 23.4953V14.1953C3 8.94531 6 6.69531 10.5 6.69531H25.5C30 6.69531 33 8.94531 33 14.1953V23.1953C33 28.4453 30 30.6953 25.5 30.6953H12.75"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-miterlimit="10"
                          stroke-linecap="round"
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M13.4549 15.4609L6.31494 11.3359"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M29.685 24.8359L22.545 20.7109"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M4.81494 13.9302L7.81494 8.74023"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M28.1851 27.4302L31.1851 22.2402"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M23.25 18.0859C23.25 19.0459 22.995 19.9309 22.545 20.7109C21.63 22.2859 19.935 23.3359 18 23.3359C16.065 23.3359 14.37 22.2859 13.455 20.7109C13.005 19.9309 12.75 19.0459 12.75 18.0859C12.75 17.1259 13.005 16.2409 13.455 15.4609C14.37 13.8859 16.065 12.8359 18 12.8359C19.935 12.8359 21.63 13.8859 22.545 15.4609C22.995 16.2409 23.25 17.1259 23.25 18.0859Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M29.685 11.3359L22.545 15.4609"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M13.4549 20.7109L6.31494 24.8359"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M31.1851 13.9302L28.1851 8.74023"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M7.81494 27.4302L4.81494 22.2402"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                ...
                <Item
                  ...
                  icon={
                    <SvgIcon>
                      ...
                      >
                        <path
                          d="M18.0074 32.9757C26.2744 32.9757 32.9762 26.274 32.9762 18.0069C32.9762 9.73985 26.2744 3.03809 18.0074 3.03809C9.74034 3.03809 3.03857 9.73985 3.03857 18.0069C3.03857 26.274 9.74034 32.9757 18.0074 32.9757Z"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M9.20581 6.03223L21.4503 18.3067L21.4802 11.4958"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                        <path
                          d="M26.7942 29.9684L14.5497 17.709L14.5198 24.5048"
                          stroke="currentcolor"
                          stroke-width="2.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                ...
                <footer >
                  <Typography mt={20} mb={2}>
                    <h8>2024 &copy; YTLC All Rights Reserved</h8>
                  </Typography>
                </footer>
              </Box>
            </Menu>

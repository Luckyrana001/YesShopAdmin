...
export function OnHoldDetails() {
  ...
  const handleRowClick = (params) => {
    ...
    DebugLog(
      "onHoldALl Transaction RowSelected  " +
        JSON.stringify(onHoldAllTransactionsRowSelected)
    );
    saveToLocalStorageJsonObject(
      NAV_ONHOLD_ALL_TRANSACTIONS,
      onHoldAllTransactionsRowSelected
    );
    navigate(CONSTANT.ON_HOLD_ALL_TRANSACTIONS_DETAILS);
  };
  ...
  function requestOnHoldDetails() {
    try {
      if (isNetworkConnectionAvailable) {
        ...
        const data = getFromLocalStorageJsonObject(NAV_ONHOLD_DETAILS);
        // Create a copy of the object
        const requestObject = { ...data };
        // Remove the key from the copy
        delete requestObject["companyName"];
        ...
        initializeEncryption(
          ...
          getOnHoldPayoutCycle(onholdCompanyRequestData)
            .then((response) => {
      ...
      <SnackbarProvider maxSnack={3}>
        ...
        >
          ...
          <Grid container direction={"row"} alignItems={"center"} mb={2} ml={2}>
            <Grid item mr={2}>
              <IconButton href={CONSTANT.ON_HOLD_ROUTE} width={12}>
            ...
            <Grid item>
              <Typography
                ...
                variant="h3"
              >
                {getFromLocalStorageJsonObject(NAV_ONHOLD_DETAILS).companyName}
              </Typography>
            </Grid>
          </Grid>
          {/* Header */}
            ...
            {onHoldSummary.length > 0 ? (
              ...
              >
                <DataGrid
                  ...
                  columns={onHoldPayoutCycleColumnHeader}

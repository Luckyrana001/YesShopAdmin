...
import { getOnHoldSummary, getWitholdingTaxDetails } from "../../services/ApiService";
import { useNavigate } from "react-router-dom";
import { onHoldSummaryColumnHeader, withholdingTaxColumnHeader } from "../../components/ColumnHeader";
      ...
      if (isNetworkConnectionAvailable) {
        ...
        getWitholdingTaxDetails(requestData)
          .then((response) => {
             ...
             const rowsWithIds = response.data.result.withholdingTaxDetails.map(row => ({ ...row, id: generateRandomId() }));

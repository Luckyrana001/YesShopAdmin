...
// login images
import loginBg from "../../assets/login/Login-BG-2.jpg";
import logo from "../../assets/login/Logo.svg";


export const iconsImgs = {
    alert, bell, bills, budget, card, check, empty_check, gears, home, menu, plane, plus, report, search, user, wallet, wealth , loginBg,
    logo
